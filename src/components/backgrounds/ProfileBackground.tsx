...
export function ProfileBackground() {
  return (
    <>
      ...
      >
        {/* WARM CENTRAL GLOW — amber, top-center */}
        <div style={{
          position: 'absolute',
          top: '5%', left: '20%',
          ...
          filter: 'blur(120px)',
          animation: 'prof-bk1 96s ease-in-out infinite',
          willChange: 'transform',
        }} />

        {/* COOL COUNTER-GLOW — bottom-left teal */}
        <div style={{
          position: 'absolute',
          bottom: '-12%', left: '-10%',
          ...
          filter: 'blur(130px)',
          animation: 'prof-bk2 108s ease-in-out infinite',
          willChange: 'transform',
        }} />

        {/* RIGHT EDGE WARM HINT */}
        <div style={{
          position: 'absolute',
          top: '25%', right: '-10%',
          ...
          filter: 'blur(90px)',
          animation: 'prof-bk3 82s ease-in-out infinite',
          willChange: 'transform',
        }} />

        {/* GRAIN TEXTURE — adds depth */}
        <div style={{
          position: 'absolute',
          inset: 0,
